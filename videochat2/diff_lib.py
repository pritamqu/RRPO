...
#####
# Copied from https://github.com/thunlp/Muffin/blob/main/utils/diff_lib.py
#####
...
def get_diff_ids(a_seq, b_seq, min_match_size=3):
    ...
    print(a_modification_spans, b_modification_spans)
...
### written by ps
def get_diff_signs(seq1, seq2, min_match_size=3):


    mod_map = generate_modification_mapping(seq1, seq2, min_match_size=min_match_size)
    a_modification_spans = list(mod_map.keys())
    b_modification_spans = list(mod_map.values())
    # print(a_modification_spans, b_modification_spans)
    sign1=[0]*len(seq1)
    ...
    phrase_num=1
    for a, b in zip(a_modification_spans, b_modification_spans):
        # print(seq1[a[0]-5: a[-1]+5])
        # print(seq2[b[0]-5: b[-1]+5])
        ...
        # print(sign1[a[0]-5: a[-1]+5])
        # print(sign2[b[0]-5: b[-1]+5])

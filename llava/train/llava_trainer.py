...
class RRPOTrainer(LLaVATrainer):
    """
    ...
    def concatenated_forward(self, 
        ...
        neg_modalities = inputs['neg_modalities']
        ...
        # batch_images=images+images # weird that this did not work
        batch_images=[]
        batch_images.extend(images)
        batch_images.extend(neg_images)
        ...
        (
            ...
            labels=batch_labels,
            # images=torch.cat([images, images], dim=0).to(model.dtype),
            images=batch_images,
            image_sizes=image_sizes+neg_image_sizes,
            signs=batch_signs,
            forward_mode='rrpo',
            modalities=modalities+neg_modalities,
        )
    ...
    def compute_loss(self, 
        ...
        align_dict = self.concatenated_forward(model, inputs)
        with torch.no_grad():
